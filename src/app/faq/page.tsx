...
export default function FAQPage() {
  ...
  const faqData = [
    ...
    },
    {
      ...
      answer: 'We differentiate ourselves through personalized service, expertise in both US and Indian tax systems, competitive pricing, and a commitment to client education. Our director, Ram Chowdhary, brings over 5 years of experience and a client-centric approach to every engagement.',
      icon: Star
    },
    {
      id: 'q9',
      ...
      answer: 'You can reach our customer support team through multiple channels: phone (USA: +1 (502) 718-0460, India: +91-9493395299), email (info@advoraservices.com), or through our website\'s contact form. We\'re available during business hours and typically respond within 24 hours.',
      icon: Phone
    },
    {
      id: 'q10',
