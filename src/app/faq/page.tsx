...
export default function FAQPage() {
  ...
  const faqData = [
    ...
    },
    {
      ...
      answer: 'You can reach our customer support team through multiple channels: phone (India: +91-9493395299), email (info@advoraservices.com), or through our website\'s contact form. We\'re available during business hours and typically respond within 24 hours.',
      icon: Phone
    },
    {
      id: 'q10',
